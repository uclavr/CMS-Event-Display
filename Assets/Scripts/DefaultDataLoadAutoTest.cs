...
public class DefaultDataLoadAutoTest : MonoBehaviour
{
    private int indexer;
    ...
    //public void LoadJson(TextAsset jsonText_)
    //{
    //    jsonText = jsonText_;
    //    totalJson = JObject.Parse(jsonText.text);
    //}
    ...
    //                {
    //                    item.GetComponent<MeshRenderer>().sharedMaterial = secondaryVertexMaterial;
    ...
    //                foreach (var item in children)
    //                {
    //                    item.GetComponent<MeshRenderer>().sharedMaterial = vertexMaterial;
    //                    VertexComponent component = item.AddComponent<VertexComponent>();
    ...
    //                foreach (var item in children)
    //                {
    //                    item.GetComponent<MeshRenderer>().sharedMaterial = jetMaterial;
    ...
    //                foreach (var item in children)
    //                {
    //                    item.GetComponent<MeshRenderer>().sharedMaterial = muonMaterial;
    ...
    //                foreach (var item in children)
    //                {
    //                    item.GetComponent<MeshRenderer>().sharedMaterial = emMaterial;
    ...
    //            case "EBRecHits_V2":
    //            case "ESRecHits_V2":
    //                child.GetComponent<MeshRenderer>().sharedMaterial = emMaterial; break;
    //            case "HBRecHits_V2":
    //            case "HERecHits_V2":
    //            case "HORecHits_V2":
    //            case "HFRecHits_V2":
    //                child.GetComponent<MeshRenderer>().sharedMaterial = hadronMaterial; break;
    ...
    //                }*/
    //                foreach (var item in children) { item.GetComponent<MeshRenderer>().sharedMaterial = mMaterial; }
    ...
    //                foreach (var item in children)
    //                {
    //                    item.GetComponent<MeshRenderer>().sharedMaterial = trackMaterial;
    ...
    //                foreach (var item in children)
    //                {
    //                    //item.GetComponent<MeshRenderer>().sharedMaterial =
    //                    VertexComponent component = item.AddComponent<VertexComponent>();
    ...
    //                foreach (var item in children)
    //                {
    //                    child.GetComponent<MeshRenderer>().sharedMaterial = cscMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = cscColor;
    //                    indexer++;
    //                }
    //                break;
    //            case "TrackDets_V1":
    ...
    //                foreach (var item in children)
    //                {
    //                    child.GetComponent<MeshRenderer>().sharedMaterial = tdMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = tdColor;
    //                    indexer++;
    //                }
    //                break;
    ...
    //                foreach (var item in children)
    //                {
    //                    child.GetComponent<MeshRenderer>().sharedMaterial = pixelMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = spColor;
    //                    indexer++;
    //                }
    //                break;
    ...
    //                foreach (var item in children)
    //                {
    //                    child.GetComponent<MeshRenderer>().sharedMaterial = stripMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = ssColor;
    //                    indexer++;
    //                }
    //                break;
    //            case "DTRecHits_V1":
    ...
    //                foreach (var item in children)
    //                {
    //                    child.GetComponent<MeshRenderer>().sharedMaterial = dtrechitMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = dtrColor;
    //                    indexer++;
    //                }
    //                break;
    ...
    //                foreach (var item in children)
    //                {
    //                    child.GetComponent<MeshRenderer>().sharedMaterial = dtrecsegmentMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = dtrsColor;
    //                    indexer++;
    //                }
    //                break;
    ...
    //                foreach (var item in children)
    //                {
    //                    item.GetComponent<MeshRenderer>().sharedMaterial = cscrechitMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = cscrhColor;
    //                    indexer++;
    //                }
    //                break;
    ...
    //                foreach (var item in children)
    //                {
    //                    item.GetComponent<MeshRenderer>().sharedMaterial = matchingcscsMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = mcscsColor;
    //                    indexer++;
    //                }
    //                break;
    ...
    //                foreach (var item in children)
    //                {
    //                    child.GetComponent<MeshRenderer>().sharedMaterial = trackingrechitsMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = trhColor;
    //                    indexer++;
    //                }
    //                break;
    //            case "CaloTowers_V2":
    ...
    //                foreach (var item in children)
    //                {
    //                    child.GetComponent<MeshRenderer>().sharedMaterial = calotowerMaterial;
    //                    item.GetComponent<MeshRenderer>().sharedMaterial.color = ctColor;
    //                    indexer++;
    //                }
    //                break;
    //            default: break;
    ...
    //}
    public void ProcessOBJ(GameObject loadedObject, string fileName)
    {
