...
namespace CutFeatureObjects
{
    public class CutTrack : CutTrackObject
    {
        protected override void Start()
        {
            ...
            else if (loader.GetComponent<fileLoadMultiple>() != null) gameObjects = loader.GetComponent<fileLoadMultiple>().trackObjects;
            else if (loader.GetComponent<DefaultDataLoad>() != null) gameObjects = loader.GetComponent<DefaultDataLoad>().trackObjects;
