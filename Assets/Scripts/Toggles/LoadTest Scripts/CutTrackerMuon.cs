...
namespace CutFeatureObjects
{
    public class CutTrackerMuon : CutTrackObject
    {
        protected override void Start()
        {
            ...
            else if (loader.GetComponent<fileLoadMultiple>() != null) gameObjects = loader.GetComponent<fileLoadMultiple>().trackerMuonObjects;
            else if (loader.GetComponent<DefaultDataLoad>() != null) gameObjects = loader.GetComponent<DefaultDataLoad>().trackerMuonObjects;
