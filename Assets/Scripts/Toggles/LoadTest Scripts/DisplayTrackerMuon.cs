...
public class DisplayTrackerMuon : MonoBehaviour
{
    // Object data
    ...
    private const int momentumIndex = 0, etaIndex = 1, phiIndex = 2, chargeIndex = 3;
    private int numObjParam = 4; // *** hardcoded for jets
